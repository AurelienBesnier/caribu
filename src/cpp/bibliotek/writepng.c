...
////////// / / / / / / / / Write_Png / / / / / / / / / ///////////
void
Write_Png_File(FILE* out, int iViewHeight, int iViewWidth)
{
...
#define SIZEOF_IEND 14
        /* piqu� dans une image Gimp */
        char My_IEND[SIZEOF_IEND] = {
                0x00, 0x00, 0x00, 0x00, 0x49, 0x45, 0x4e,
...
#define FILTER_TYPE 0
        ...
        /* warnig: pbs potentiels de compatiblit� GLint/int
        ...
        if ((ImageBuffer == NULL) || (row_buf == NULL)) {
                fprintf(stderr, "Plus de m�moire dans Output()\n");
                exit(Quitter(-1));
        }
        ...
        // transf�re le buffer en appliquant des modifs (coloration du fond...)
                ...
                for (ibcol = 0; ibcol < iViewWidth; ibcol++) {
                        for (ibpix = 0; ibpix < BYTE_PER_PIXEL; ibpix++) {
                                row_buf[ibcol * BYTE_PER_PIXEL + ibpix] =
                                  ImageBuffer[iblig * iViewWidth *
                                                BYTE_PER_PIXEL +
                                              ibcol * BYTE_PER_PIXEL + ibpix] *
                                  2;
                        }
                }
         ...
         * Version 0: piquer l'info ds une image et l'�crire brute */
