...
double
Vecteur::prod_scalaire(const Vecteur& v1) const
{
...
void
Vecteur::formation_vecteur(const Point& p1, const Point& p2)
{
...
Point
Point::operator+(const Homogene& vect) const
{
        Point res;
...
reel
Point::distance_pt_plan(const Point& a, const Point& b, const Point& c) const
{
