...
// //////// / / / / / / / / CreateOutName / / / / / / / / / ///////////
void
CreateOutName(char* pcDest, char* pcSource, char* ext)
{
        ...
        char *pcDotPlace = NULL, *pcNewDotPlace = NULL;
...
double
dArcTangente(float fOpp, float fAdj)
{
...
double
dArcTangente4Can(float fOpp, float fAdj)
{
        /** Valeur de retour */
        double dAngle;
