/* Class OGLPrim dealing the Open-GL primitives flow, coming from Radek's
 CommLib
...
class OGLPrim
{
      public:
        ...
        // contains the triangles resulting from the triangulation of the
        // primitive
        float T[NB_TRIANGLE_PRIM][3][3];
        int nbT; // Number of triangles describing the primitive
        float
          area; // approximate surface computed by the sum of triangles surface
        float G[3]; // Gravity center of the primitive coming from the G of each
                    // triangles
