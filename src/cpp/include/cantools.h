...
{
        int iTranspar, iEspeceId, iPlanteId, /* plante Id */
...
/* Image */
void
Get_Image(char* ImageBuffer, int iViewWidth, int iViewHeight);
...
int
Quitter(int code); /* chaque programme sa version */
...
void
Decode_Data(CanData* res, double donnee); /*label2int.c */
