 ...
 */
#define M_2PI                                                                  \
        6.2831853071795864769E0 /*Hex  2^ 2 * 1.921FB                          \
54442D18 */
#endif                          /* _OSF_SOURCE */
...
void
raus(bool cond, const char* msg = "Cause mysterieuse ...");
inline void
STOP(int i)
{
...
void
Dehors(bool cond, const char* msg, const int ligne);
...
// Le nom du fichier de log permet de retrouver le programme fautif.
void
TestMemoire(bool cond, const char* msg, const int ligne);

//-******** T_MAX
template<class Type>
inline Type
T_max(Type v1, Type v2)
{
        return ((v1 >= v2) ? v1 : v2);
}
...
inline Param_Inter&
Param_Inter::operator=(Param_Inter& a)
{
        origine = a.origine;
...
inline void
Param_Inter::change_origine(Point& ori)
{
        origine = ori;
}

inline void
Param_Inter::change_direction(Vecteur& dir)
{
        //	direction=dir;
        direction[0] = dir[0];
        direction[1] = dir[1];
...
inline void
Param_Inter::change_poids(const double& p)
{
        poids = p;
}
