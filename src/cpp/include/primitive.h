...
class Primitive
{
      ...
      public:
        ...
        virtual double distance2_point(
          Point&) = 0; // carre de la distance du point P a la primitive
...
class Polygone : public Primitive
{
      protected:
        ...
        Point *sommet, isob;
        Vecteur normale;
        reel cst_equ_plan; /*constante de l'equation du plan du polygone :
                              P*N-D=0 */
        float dGS;
      ...
      public:
        ...
        int nb_sommet() { return nb_sommets; }
        Point& sommets(int i) { return sommet[i]; }
        Vecteur normal() { return normale; }
        reel cst_equ() { return cst_equ_plan; }
        void cst_equ(reel cst) { cst_equ_plan = cst; }
        // Fonctions qui permet de savoir si un polygone est contenu dans une
        // boite ou non
        ...
        Vecteur azi();
        double distance2_point(
          Point&); // carre de la distance du point P au polygone (convexe)
...
class Triangle : public Polygone
{
      public:
        ...
        void show(const char* msg = "", ostream& out = cout)
        {
                out << msg << "-Triangle :";
                qui();
                out << "          " << sommet[0][0] << " " << sommet[0][1]
                    << " " << sommet[0][2] << endl;
                out << "          " << sommet[1][0] << " " << sommet[1][1]
                    << " " << sommet[1][2] << endl;
                out << "          " << sommet[2][0] << " " << sommet[2][1]
                    << " " << sommet[2][2] << endl;
        }
        double surface();
};
