...
extern "C"
{
        ...
        /* for sending and receiving data, use function from multiprocess
        communication
        ...
        int CMSendCommSymbol(int index,
                             unsigned long distance,
                             Cmodule_type* two_modules,
                             CTURTLE* turtle);
        int CMGetCommunicationModule(int index,
        ...
        int CSGetData(int* master,
                      unsigned long* distance,
                      Cmodule_type* two_modules,
                      CTURTLE* turtle);
        void CSSendData(int master,
                        unsigned long dist,
