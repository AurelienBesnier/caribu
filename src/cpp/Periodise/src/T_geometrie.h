...
class Point : public Homogene
{
      public:
        ...
        Point operator-(
          const Homogene&); // soustraction d'un point et d'un vecteur
...
class Vecteur : public Homogene
{
      public:
        ...
        //  Vecteur& operator = (Vecteur&u){return
        //  Homogene::operator=((Homogene&)u);}
...
Matrice<Type>::operator=(Matrice<Type>& A)
{
        ...
        if (n != A.n || m != A.m) {
                cout << "ERREUR - Impossible d'egaliser 2 matrices de taille "
                        "differente\n";
                cout.flush();
                exit(1);
        } else {
