...
// Diffus (Lambertian)
class Lambert : virtual public Actop
{
      protected:
        double reflectance;
        double transmit;
      ...
      public:
        Lambert()
        //    { reflectance[sup]=0.05;reflectance[inf]=0.05; transmit=0.05;}
        //    //Vis { reflectance[sup]=0.49;reflectance[inf]=0.49;
        //    transmit=0.49;} //IR { reflectance[sup]=0.0;reflectance[inf]=0.99;
        //    transmit=0.01;} //piege
        {
                reflectance = 0.5;
                transmit = 0.0;
...
class Fresnel : virtual public Actop
{
      protected:
      ...
      public:
        Fresnel()
        {
                Fr0 = fr_0(1.4);
                hair = 0.1;
                printf("Fresnel <!> Cstructeur par defaut!\n");
        }
        ...
        Fresnel(double n, double h = 0.1)
        {
                Fr0 = fr_0(n);
                hair = h;
                printf("Fresnel cstr : Fr0 =%.4g\n", Fr0);
        }
        void interact(Transf& param);
        double lux(Transf& param); // pipo (a modif qd temps : pb de
                                   // directionalite -> catpeur
        void show() { cout << "Fresnel[show]\n"; }
...
class Gauss : virtual public Fresnel
{
      protected:
        double zeta;
      ...
      public:
        Gauss()
        {
                ...
                hair = 0.1;
                zeta2 = 0.04;
                printf("Gauss <!> cstructeur par defaut\n");
        }
        Gauss(double n, double h, double xi)
          : Fresnel(n, h)
        {
                zeta = xi;
                zeta2 = xi * xi;
        ...
        void interact(Transf& param);
        double lux(Transf& param); // pipo (a modif qd temps : pb de
                                   // directionalite -> capteur
        void show() { cout << "Gauss[show]\n"; }
