...
#include "image.h"
void
lateral(Image* pict, double x, double y, double dx, double dy, int col);
void
pave(Image* pict, double x, double y, cord, int col);
...
void
pave(Image& pict, double x, double y, double dx, double dy, int col)
{
        int i, j;
...
/*
to compile
 g++ -o pave -I ../bibliotek -I /home/chelle/rezo/dev/mathlib/include/ pavage.C
$EXE/outils.o $EXE/T_geometrie.o -lm
