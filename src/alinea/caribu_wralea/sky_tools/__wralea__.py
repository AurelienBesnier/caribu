...
turtle = Fa(
    uid="24e4eb784e8511e6bff6d4bed973e64a",
    name="Turtle",
    ...
    nodeclass="turtle",
    inputs=[
        dict(name="sectors", interface=IEnumStr(["16", "46"]), value="16"),
    ...
    outputs=[
        dict(name="Energy", interface=ISequence),
...
Normalise_Sky = Fa(
    uid="24e4eb794e8511e6bff6d4bed973e64a",
    name="Normalise_Sky",
...
_98394928 = CNF(
    uid="24e4eb724e8511e6bff6d4bed973e64a",
    ...
    outputs=[],
    elt_factory={
        2: ("alinea.caribu.Sky_tools", "GenSkyFile"),
    ...
    elt_value={
        ...
        9: [(0, "3")],
        10: [
            (0, "PackageData(alinea.caribu.data, Meteo2006.csv)"),
            (1, "None"),
            (2, "None"),
        ],
        "__in__": [],
...
GetLight = Fa(
    uid="24e4eb7a4e8511e6bff6d4bed973e64a",
    name="GetLight",
...
_98394576 = CNF(
    uid="24e4eb734e8511e6bff6d4bed973e64a",
    name="essai1_loop",
    description="",
    ...
    outputs=[],
    elt_factory={
        2: ("openalea.flow control", "annotation"),
    ...
    elt_data={
        2: {
            "posx": -77.291014019941002,
            "posy": 87.596482555933164,
            "txt": "Data Group",
        },
        3: {
            "posx": 2207.0406429610161,
        ...
        8: {"posx": 334.92772741974437, "posy": 87.596482555933136, "txt": "Zenith Nb"},
        9: {
            "block": False,
        ...
        16: {
            "posx": 199.23905836251464,
            "posy": 85.878904466601114,
            "txt": "Azimut Nb",
        },
        17: {"posx": 75.57343593060898, "posy": 89.314060645265158, "txt": "Latitude"},
        18: {
            "block": False,
            "caption": "read_meteo_file",
            "hide": True,
        ...
        34: {
            "posx": -260.42343136510772,
            "posy": 62.911326377269091,
            "txt": "Meteo file",
        },
        35: {
            "posx": -130.53593478923369,
    ...
    elt_value={
        ...
        18: [],
        19: [
            (0, "PackageData(alinea.caribu.data, Rg_2J.csv)"),
            (1, "None"),
            (2, "None"),
        ],
        20: [],
...
GenSky = Fa(
    uid="24e4eb7b4e8511e6bff6d4bed973e64a",
    name="gensky",
...
add_sun = Fa(
    uid="24e4eb7c4e8511e6bff6d4bed973e64a",
    name="add_sun",
...
merge2skies = Fa(
    uid="24e4eb7d4e8511e6bff6d4bed973e64a",
    name="merge2skies",
...
mergeNskies = Fa(
    uid="259cd4804e8511e6bff6d4bed973e64a",
    name="mergeNskies",
    description="",
    category="scene.sky",
...
get_meteo_dat = Fa(
    uid="259cd4814e8511e6bff6d4bed973e64a",
    name="get_meteo_dat",
    description="",
...
GenSkyFile = CNF(
    uid="24e4eb744e8511e6bff6d4bed973e64a",
    name="GenSkyFile",
    description="Generate one light file from one group number (one day for example)",
    category="scene.sky",
    doc="",
    inputs=[
        {"desc": "", "interface": None, "name": "meteo table", "value": None},
    ...
    elt_factory={
        2: ("alinea.Caribu.Sky_tools", "gensky_rg"),
...
Filename = Fa(
    uid="259cd4824e8511e6bff6d4bed973e64a",
    name="Filename",
...
Genlight = Fa(
    uid="259cd4834e8511e6bff6d4bed973e64a",
    ...
    inputs=[
        ...
        {"interface": IFileStr, "name": "outfile name", "value": "sky.light"},
    ],
...
GetLightsSun = Fa(
    uid="259cd4844e8511e6bff6d4bed973e64a",
    name="GetLightSun",
    description="",
    category="data i/o",
...
group_seq = Fa(
    uid="259cd4854e8511e6bff6d4bed973e64a",
    name="group_seq",
...
place_sun = Fa(
    uid="259cd4864e8511e6bff6d4bed973e64a",
    name="place_sun",
...
SkyPlusSun = CNF(
    uid="24e4eb754e8511e6bff6d4bed973e64a",
    name="SkyPlusSun",
    ...
    outputs=[],
    elt_factory={
        2: ("alinea.Caribu.Sky_tools", "gensun"),
    ...
    elt_value={
        2: [(0, "0.0"), (1, "1"), (2, "1.0"), (3, "49.869999999999997")],
        3: [],
...
_98394864 = CNF(
    uid="24e4eb764e8511e6bff6d4bed973e64a",
    name="gensky_group",
    ...
    outputs=[{"interface": None, "name": "sky object"}],
    elt_factory={
        19: ("alinea.Caribu.Sky_tools", "group_seq"),
        20: ("openalea.function operator", "map"),
        21: ("openalea.flow control", "annotation"),
        22: ("openalea.flow control", "X"),
        23: ("alinea.Caribu.Sky_tools", "gensky"),
...
spitters_horaire = Fa(
    uid="259cd4874e8511e6bff6d4bed973e64a",
    ...
    inputs=[
        {"interface": ISequence, "name": "meteo table", "value": None},
        {"interface": IFloat, "name": "latitude", "value": 49.869999999999997},
    ],
...
Gensun = Fa(
    uid="259cd4884e8511e6bff6d4bed973e64a",
    name="gensun",
    ...
    inputs=[
        ...
        {"interface": IFloat, "name": "lat", "value": 49.869999999999997},
    ],
...
read_meteo_file = Fa(
    uid="259cd4894e8511e6bff6d4bed973e64a",
...
_98394608 = CNF(
    uid="24e4eb774e8511e6bff6d4bed973e64a",
    name="gensky_rg",
    description="generates and merges direct and diffuse components",
    category="scene.light",
    doc="",
    inputs=[
        {"interface": IFloat, "name": "Rd", "value": 1.0},
        {
            "interface": IEnumStr(enum=["soc", "uoc"]),
            "name": "Sky Type",
            "value": "soc",
    ...
    outputs=[{"interface": None, "name": "sky object"}],
    elt_factory={
        2: ("alinea.Caribu.Sky_tools", "gensky"),
    ...
    elt_ad_hoc={
        2: {"position": [242.5, 352.5], "userColor": None, "useUserColor": False},
        3: {"position": [452.5, 338.75], "userColor": None, "useUserColor": False},
        4: {"position": [437.5, 456.25], "userColor": None, "useUserColor": False},
        5: {
            "position": [425.11396011396005, 570.44254510921178],
            "userColor": None,
            "useUserColor": False,
        },
        6: {
            "position": [322.27160493827148, 582.56790123456778],
            "userColor": None,
            "useUserColor": False,
        },
        "__in__": {
            "position": [347.5, 278.75],
            "userColor": None,
            "useUserColor": False,
        },
        "__out__": {
            "position": [334.15147198480531, 649.51187084520427],
            "userColor": None,
            "useUserColor": False,
        },
    },
