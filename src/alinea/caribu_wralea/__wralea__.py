...
CaribuScene = Fa(
    uid="96612da84e8311e6bff6d4bed973e64a",
    name="CaribuScene",
    authors="C. Fournier",
...
runCaribu = Fa(
    uid="96612da94e8311e6bff6d4bed973e64a",
    name="Caribu",
    authors="C. Fournier",
    description="",
    category="scene.light",
...
vcaribu = Fa(
    uid="96612daa4e8311e6bff6d4bed973e64a",
    name="vcaribu",
    ...
    outputs=[
        {"interface": None, "name": "irradiances", "desc": ""},
...
generate_scene = Fa(
    uid="96612dab4e8311e6bff6d4bed973e64a",
    name="generate scene",
...
selectOutput = Fa(
    uid="96612dac4e8311e6bff6d4bed973e64a",
    name="selectOutput",
    authors="M. Chelle,C. Fournier (wralea authors)",
...
getIncidentEnergy = Fa(
    uid="96612dad4e8311e6bff6d4bed973e64a",
...
getSoilEnergy = Fa(
    uid="96612dae4e8311e6bff6d4bed973e64a",
    name="getSoilEnergy",
    authors="C. Fournier",
    category="scene.light",
    nodemodule="alinea.caribu.CaribuScene_nodes",
...
WriteCan = Fa(
    uid="96612daf4e8311e6bff6d4bed973e64a",
    name="WriteCan",
    authors="M. Chelle,C. Fournier (wralea authors)",
    description="",
    category="io",
...
periodise = Fa(
    uid="96612db04e8311e6bff6d4bed973e64a",
    name="Periodise",
    authors="M. Chelle,C. Fournier (wralea authors)",
...
encode_label = Fa(
    uid="96612db14e8311e6bff6d4bed973e64a",
    name="encode label",
    authors="C. Fournier",
    description="",
    category="io",
...
decode_label = Fa(
    uid="96612db24e8311e6bff6d4bed973e64a",
    name="decode label",
    authors="C. Fournier",
    description="",
    category="io",
...
misc_reduceDict = Fa(
    uid="96612db34e8311e6bff6d4bed973e64a",
    name="reduceDict",
    authors="C. Fournier",
...
misc_filterby = Fa(
    uid="96612db44e8311e6bff6d4bed973e64a",
    name="filterby",
    authors="C. Fournier",
...
misc_mydict = Fa(
    uid="96612db54e8311e6bff6d4bed973e64a",
    name="mydict",
    authors="C. Fournier",
    ...
    nodemodule="alinea.caribu.misc_nodes",
    nodeclass="mydict",
    inputs=[{"interface": None, "name": "liste of tuple", "value": None}],
...
PARaggregators = Fa(
    uid="96612db64e8311e6bff6d4bed973e64a",
    name="PARaggregators",
    authors="M. Chelle,C. Fournier (wralea authors)",
    ...
    inputs=[
        {"interface": None, "name": "aggregation table", "value": None, "desc": ""}
    ],
...
light_source = Fa(
    uid="96612db74e8311e6bff6d4bed973e64a",
    name="light source",
    alias=["light string"],
    authors="M. Chelle,C. Fournier (wralea authors)",
    ...
    inputs=[
        ...
        {"interface": IFloat, "name": "elevation angle (deg)", "value": 90, "desc": ""},
        {"interface": IFloat, "name": "azimuth angle (deg)", "value": 0, "desc": ""},
    ],
