...
from openalea.core import IBool, IData, IDict, IFileStr, IFloat, IInt, ISequence, IStr
...
GenOutput = Fa(
    uid="5cc625664e8411e6bff6d4bed973e64a",
    name="GenOutput",
...
FileCaribuScene = Fa(
    ...
    inputs=[
        {
            "interface": IFileStr(filter="*.can", save=False),
            "name": "CanFile",
            "value": None,
            "desc": "",
        },
        {
            "interface": IFileStr(filter="*.light", save=False),
            "name": "LightFile",
            "value": None,
            "desc": "",
        },
        {
            "interface": IFileStr(filter="*.8", save=False),
            "name": "PatternFile",
            "value": None,
            "desc": "",
        },
        {
            "interface": IFileStr(filter="*.opt", save=False),
            "name": "OptFile",
            "value": None,
            "desc": "",
        },
    ...
    outputs=[
        {"interface": IStr, "name": "CaribuScene", "desc": ""},
        {"interface": IDict, "name": "Maping dict (see CaribuScene)"},
    ],
    widgetmodule=None,
    widgetclass=None,
)
...
ObjCaribuScene = Fa(
    uid="5cc625684e8411e6bff6d4bed973e64a",
    name="ObjCaribuScene",
    authors="M. Chelle,C. Fournier (wralea authors)",
    description="deprecated node",
    nodemodule="alinea.caribu.deprecated_nodes",
    ...
    inputs=[
        ...
        {"interface": IStr, "name": "LightString", "value": None, "desc": ""},
        {
            "interface": ISequence,
            "name": "pattern",
            "value": None,
    ...
    outputs=[
        {"interface": IStr, "name": "CaribuScene", "desc": ""},
        {"interface": IDict, "name": "Mapid", "desc": ""},
    ],
    widgetmodule=None,
    widgetclass=None,
)
...
getEi = Fa(
    uid="5cc625694e8411e6bff6d4bed973e64a",
    name="get Ei",
    authors="M. Chelle,C. Fournier (wralea authors)",
    description="deprecated node",
    nodemodule="alinea.caribu.deprecated_nodes",
    ...
    outputs=[
        {
            ...
            "name": "Qi",
            "desc": (
                "incident light flux received on an horizontal "
...
MCSail_MCSail = Fa(
    uid="5cc6256a4e8411e6bff6d4bed973e64a",
    name="MCSail",
    authors="M. Chelle,C. Fournier (wralea authors)",
...
S2v_S2v = Fa(
    uid="5cc6256b4e8411e6bff6d4bed973e64a",
    name="S2v",
    authors="M. Chelle,C. Fournier (wralea authors)",
    ...
    nodeclass="S2v",
    inputs=[
        {"interface": None, "name": "CaribuScene", "value": None, "desc": ""},
    ...
    outputs=[
        {"interface": IStr, "name": "SailScene", "desc": ""},
        {"interface": ISequence, "name": "TriangleLayerLabels", "desc": ""},
...
Canestra = Fa(
    uid="5cc6256c4e8411e6bff6d4bed973e64a",
    name="Canestra",
    authors="M. Chelle,C. Fournier (wralea authors)",
...
addSoil = Fa(
    uid="5cc6256d4e8411e6bff6d4bed973e64a",
    name="addSoil",
    authors="C. Fournier",
    description="",
    category="deprecated",
    ...
    nodeclass="addSoil",
    inputs=[
        {"interface": IData, "name": "CaribuScene", "value": None, "desc": ""},
        {"interface": IFloat, "name": "altitude (z)", "value": 0.0},
        {"interface": IBool, "name": "Copy Caribuscene", "value": True, "desc": ""},
    ],
    outputs=[
        {"interface": IData, "name": "CaribuScene", "desc": ""},
        {
            "interface": IDict,
            "name": "Soil_id2Caribu_id",
...
addShapes = Fa(
    uid="5cc6256e4e8411e6bff6d4bed973e64a",
    name="addShapes",
    authors="C. Fournier",
    description="",
    category="deprecated",
...
output_by_id = Fa(
    uid="5cc6256f4e8411e6bff6d4bed973e64a",
    name="Output by id",
    authors="C. Fournier",
    description="",
    category="deprecated",
...
mtg_updateMTG = Fa(
    uid="5cc625704e8411e6bff6d4bed973e64a",
    name="updateMTG",
    authors="M. Chelle,C. Fournier (wralea authors)",
    category="deprecated",
    nodemodule="alinea.caribu.deprecated_nodes",
...
mtg_to_canestra = Fa(
    uid="5cc625714e8411e6bff6d4bed973e64a",
    name="MtgToCan",
    authors="M. Chelle,C. Fournier (wralea authors)",
    ...
    inputs=[
        ...
        {"interface": IInt, "name": "Defalt for opacity", "value": 0, "desc": ""},
        {
    ...
    outputs=[
        ...
        {"interface": None, "name": "CanString", "desc": "Canestra input file"},
    ],
    widgetmodule=None,
    widgetclass=None,
)
