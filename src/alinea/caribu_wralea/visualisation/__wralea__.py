...
_150127472 = CNF(
    uid="a76da7b44e8511e6bff6d4bed973e64a",
    ...
    elt_ad_hoc={
        5: {
            "useUserColor": False,
            "position": [143.89304436535957, -393.17852282601],
            "userColor": None,
        },
        6: {
            "useUserColor": False,
            "position": [120.06352154531945, -445.85364041604765],
            "userColor": None,
        },
        "__in__": {
            "position": [150.0, -550.25],
            "userColor": None,
            "useUserColor": False,
        },
        "__out__": {
            "position": [153.30052005943537, -342.69613670133737],
            "userColor": None,
            "useUserColor": False,
        },
    },
...
gammaTrans = Fa(
    ...
    inputs=[
        {"interface": None, "name": "values", "value": None, "desc": ""},
        {"interface": IFloat, "name": "gamma", "value": 1, "desc": ""},
        {"interface": IFloat, "name": "minval", "value": None, "desc": ""},
        {"interface": IFloat, "name": "maxval", "value": None, "desc": ""},
    ],
...
saveImage = Fa(
    uid="a76da7b64e8511e6bff6d4bed973e64a",
    name="saveImage",
    ...
    nodeclass="saveImage",
    inputs=[
        {"interface": IFileStr, "name": "image_name", "value": None, "desc": ""},
        {"interface": None, "name": "scene", "value": None, "desc": ""},
    ],
...
colorScale = Fa(
    uid="a76da7b74e8511e6bff6d4bed973e64a",
    name="colorScale",
    authors="C. Pradal (wralea authors)",
    ...
    inputs=[
        ...
        {"interface": IStr, "name": "label", "value": None, "desc": "axis label"},
    ],
...
ViewMapOnCan = Fa(
    uid="a76da7b84e8511e6bff6d4bed973e64a",
    name="ViewMapOnCan",
...
plot_can = Fa(
    uid="a76da7b94e8511e6bff6d4bed973e64a",
    name="Plot Can File",
    authors="C. Pradal (wralea authors)",
    ...
    nodeclass="plot_can",
    inputs=[
        {"interface": IFileStr(filter="*.can", save=False), "name": "can file"},
...
read_can = Fa(
    uid="a76da7ba4e8511e6bff6d4bed973e64a",
