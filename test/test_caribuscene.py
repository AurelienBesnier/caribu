...
if run_test:
    ...
    def test_instantiation_from_python():
        ...
        cs = CaribuScene(
            scene=pyscene, opt=materials, soil_reflectance=soil_reflectance
        )
        assert "par" in cs.material
        assert cs.soil_reflectance == soil_reflectance

        cs = CaribuScene(
            scene=pyscene, opt=simplified_materials, soil_reflectance=soil_reflectance
        )
        assert "par" in cs.material
        assert cs.soil_reflectance == soil_reflectance
