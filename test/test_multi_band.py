...
def test_raycasting_two_triangles_no_occlusion():
    ...
    lights = [(100, (0, 0, -1))]
    materials = dict(band1=[(0.1,)] * 2, band2=[(0.2,)] * 2)
...
def test_mixed_radiosity_three_triangles_full_occlusion():
    ...
    materials = dict(band1=[(0.1,)] * 3, band2=[(0.2,)] * 3)
    domain = (0, 0, 2, 2)
    ...
    x_res = x_mixed_radiosity(
        triangles, materials, lights, domain, soil_reflectance, diameter, layers, height
    )
