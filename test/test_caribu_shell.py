...
def test_case_1_projection_non_toric_scene(debug=False):
    ...
    sim = Caribu(
        canfile=can, skyfile=sky, optfiles=opts, resdir=None, resfile=None, debug=debug
    )
...
def test_caribu_inconsistent_case():
    ...
    sim = Caribu(canfile=can, skyfile=sky, optfiles=opts, resdir=None, resfile=None)
    ...
    try:
        ...
        assert (
            False
        ), "This test uses inconsistent options, it should raise an CaribuOptionError"
